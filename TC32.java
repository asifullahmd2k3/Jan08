...
public class TC32 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement newName = driver.findElement(By.xpath("//*[@id=\"hotlist\"]/table/tbody/tr/td[2]/input"));
		newName.click();
		WebElement newLastName = driver.findElement(By.id("name_lastcon2"));
		newLastName.sendKeys("Indian");
		WebElement newAcName = driver.findElement(By.id("con4"));
		newAcName.sendKeys("Global Media");
